...
A note specific to this project: [CONTRIBUTING.md](CONTRIBUTING.md) and
[docs/contributing.md](docs/contributing.md) are blunt about *designs* — a PR can be rejected firmly
and with a direct explanation. That bluntness is aimed at code, never at people. Critique the design;
do not make it about the contributor.
...
leaders responsible for enforcement at **conduct@heymya.ai**.
